...
import "github.com/khorevaa/r2gitsync/manager/types"
...
type (
	...
	AfterGetRepositoryAuthorsFn  func(v8end V8Endpoint, workdir string, authors *map[string]types.RepositoryAuthor) error
)
