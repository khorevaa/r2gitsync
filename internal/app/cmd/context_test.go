...
// }
//
// func (s *BaseSuite) InitializeCmdSyncTestSuite(_ *godog.TestSuiteContext) {
//
// }
//
// func (s *BaseSuite) InitializeCmdSyncScenario(_ *godog.ScenarioContext) {
// }
//
...
// 	dir := s.String(name)
//
// 	filename := filepath.Join(dir, manager2.VERSION_FILE)
