...
func (sgb *StorageGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("db: StorageGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *StorageGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{storage.Label}
	default:
		err = fmt.Errorf("db: StorageGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *StorageGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("db: StorageGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *StorageGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{storage.Label}
	default:
		err = fmt.Errorf("db: StorageGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *StorageGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("db: StorageGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *StorageGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{storage.Label}
	default:
		err = fmt.Errorf("db: StorageGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *StorageGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("db: StorageGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *StorageGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{storage.Label}
	default:
		err = fmt.Errorf("db: StorageGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *StorageSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("db: StorageSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *StorageSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{storage.Label}
	default:
		err = fmt.Errorf("db: StorageSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *StorageSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("db: StorageSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *StorageSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{storage.Label}
	default:
		err = fmt.Errorf("db: StorageSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *StorageSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("db: StorageSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *StorageSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{storage.Label}
	default:
		err = fmt.Errorf("db: StorageSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *StorageSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("db: StorageSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *StorageSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{storage.Label}
	default:
		err = fmt.Errorf("db: StorageSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
