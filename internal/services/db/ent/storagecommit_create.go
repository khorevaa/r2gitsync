...
func (scc *StorageCommitCreate) check() error {
	if _, ok := scc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "StorageCommit.created_at"`)}
	}
	if _, ok := scc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "StorageCommit.updated_at"`)}
	}
	if _, ok := scc.mutation.Number(); !ok {
		return &ValidationError{Name: "number", err: errors.New(`ent: missing required field "StorageCommit.number"`)}
	}
	...
	if _, ok := scc.mutation.ConfigurationVersion(); !ok {
		return &ValidationError{Name: "configuration_version", err: errors.New(`ent: missing required field "StorageCommit.configuration_version"`)}
	}
	if _, ok := scc.mutation.Author(); !ok {
		return &ValidationError{Name: "author", err: errors.New(`ent: missing required field "StorageCommit.author"`)}
	}
	if _, ok := scc.mutation.Description(); !ok {
		return &ValidationError{Name: "description", err: errors.New(`ent: missing required field "StorageCommit.description"`)}
	}
	if _, ok := scc.mutation.Tag(); !ok {
		return &ValidationError{Name: "tag", err: errors.New(`ent: missing required field "StorageCommit.tag"`)}
	}
	if _, ok := scc.mutation.TagDescription(); !ok {
		return &ValidationError{Name: "tag_description", err: errors.New(`ent: missing required field "StorageCommit.tag_description"`)}
	}
	if _, ok := scc.mutation.CommitAt(); !ok {
		return &ValidationError{Name: "commit_at", err: errors.New(`ent: missing required field "StorageCommit.commit_at"`)}
	}
	if _, ok := scc.mutation.StorageID(); !ok {
		return &ValidationError{Name: "storage", err: errors.New(`ent: missing required edge "StorageCommit.storage"`)}
	}
	return nil
}
