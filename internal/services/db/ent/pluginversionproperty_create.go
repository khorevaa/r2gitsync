...
func (pvpc *PluginVersionPropertyCreate) check() error {
	if _, ok := pvpc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "PluginVersionProperty.created_at"`)}
	}
	if _, ok := pvpc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "PluginVersionProperty.updated_at"`)}
	}
	if _, ok := pvpc.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`ent: missing required field "PluginVersionProperty.name"`)}
	}
	...
	if _, ok := pvpc.mutation.Default(); !ok {
		return &ValidationError{Name: "default", err: errors.New(`ent: missing required field "PluginVersionProperty.default"`)}
	}
	...
	if _, ok := pvpc.mutation.Required(); !ok {
		return &ValidationError{Name: "required", err: errors.New(`ent: missing required field "PluginVersionProperty.required"`)}
	}
	if _, ok := pvpc.mutation.GetType(); !ok {
		return &ValidationError{Name: "type", err: errors.New(`ent: missing required field "PluginVersionProperty.type"`)}
	}
	...
	if _, ok := pvpc.mutation.PluginID(); !ok {
		return &ValidationError{Name: "plugin", err: errors.New(`ent: missing required edge "PluginVersionProperty.plugin"`)}
	}
	if _, ok := pvpc.mutation.VersionID(); !ok {
		return &ValidationError{Name: "version", err: errors.New(`ent: missing required edge "PluginVersionProperty.version"`)}
	}
	return nil
}
