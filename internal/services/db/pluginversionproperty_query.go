...
func (pvpgb *PluginVersionPropertyGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(pvpgb.fields) > 1 {
		return nil, errors.New("db: PluginVersionPropertyGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := pvpgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pvpgb *PluginVersionPropertyGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{pluginversionproperty.Label}
	default:
		err = fmt.Errorf("db: PluginVersionPropertyGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (pvpgb *PluginVersionPropertyGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(pvpgb.fields) > 1 {
		return nil, errors.New("db: PluginVersionPropertyGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := pvpgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pvpgb *PluginVersionPropertyGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{pluginversionproperty.Label}
	default:
		err = fmt.Errorf("db: PluginVersionPropertyGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (pvpgb *PluginVersionPropertyGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(pvpgb.fields) > 1 {
		return nil, errors.New("db: PluginVersionPropertyGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := pvpgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pvpgb *PluginVersionPropertyGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{pluginversionproperty.Label}
	default:
		err = fmt.Errorf("db: PluginVersionPropertyGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (pvpgb *PluginVersionPropertyGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(pvpgb.fields) > 1 {
		return nil, errors.New("db: PluginVersionPropertyGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := pvpgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pvpgb *PluginVersionPropertyGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{pluginversionproperty.Label}
	default:
		err = fmt.Errorf("db: PluginVersionPropertyGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (pvps *PluginVersionPropertySelect) Strings(ctx context.Context) ([]string, error) {
	if len(pvps.fields) > 1 {
		return nil, errors.New("db: PluginVersionPropertySelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := pvps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pvps *PluginVersionPropertySelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{pluginversionproperty.Label}
	default:
		err = fmt.Errorf("db: PluginVersionPropertySelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (pvps *PluginVersionPropertySelect) Ints(ctx context.Context) ([]int, error) {
	if len(pvps.fields) > 1 {
		return nil, errors.New("db: PluginVersionPropertySelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := pvps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pvps *PluginVersionPropertySelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{pluginversionproperty.Label}
	default:
		err = fmt.Errorf("db: PluginVersionPropertySelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (pvps *PluginVersionPropertySelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(pvps.fields) > 1 {
		return nil, errors.New("db: PluginVersionPropertySelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := pvps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pvps *PluginVersionPropertySelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{pluginversionproperty.Label}
	default:
		err = fmt.Errorf("db: PluginVersionPropertySelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (pvps *PluginVersionPropertySelect) Bools(ctx context.Context) ([]bool, error) {
	if len(pvps.fields) > 1 {
		return nil, errors.New("db: PluginVersionPropertySelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := pvps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pvps *PluginVersionPropertySelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{pluginversionproperty.Label}
	default:
		err = fmt.Errorf("db: PluginVersionPropertySelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
