...
func (aq *AssetQuery) IDs(ctx context.Context) ([]uuid.UUID, error) {
	var ids []uuid.UUID
...
func (agb *AssetGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("db: AssetGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AssetGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{asset.Label}
	default:
		err = fmt.Errorf("db: AssetGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (agb *AssetGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("db: AssetGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AssetGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{asset.Label}
	default:
		err = fmt.Errorf("db: AssetGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (agb *AssetGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("db: AssetGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AssetGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{asset.Label}
	default:
		err = fmt.Errorf("db: AssetGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (agb *AssetGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("db: AssetGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AssetGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{asset.Label}
	default:
		err = fmt.Errorf("db: AssetGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AssetSelect) Strings(ctx context.Context) ([]string, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("db: AssetSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AssetSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{asset.Label}
	default:
		err = fmt.Errorf("db: AssetSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AssetSelect) Ints(ctx context.Context) ([]int, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("db: AssetSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AssetSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{asset.Label}
	default:
		err = fmt.Errorf("db: AssetSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AssetSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("db: AssetSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AssetSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{asset.Label}
	default:
		err = fmt.Errorf("db: AssetSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AssetSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("db: AssetSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AssetSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{asset.Label}
	default:
		err = fmt.Errorf("db: AssetSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
